...
public class MedidorABM {
	...
	public int agregar(int nroSerie, Cliente cliente, String direccion, Zona zona, boolean esBaja,Tarifa tarifa) throws Exception{
		if (this.traerMedidorPorNumero(nroSerie)!=null)
	        throw new Exception ("Error. Ya existe un medidor con el nroSerie:" + nroSerie);	
		return MedidorDao.getInstance().agregar(new Medidor(nroSerie, cliente, direccion, zona, esBaja, tarifa));//devuelve id agregado
	}
